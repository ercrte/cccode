...
from julycode.providers.base import ChatMessage, LLMProvider, TokenUsage
from julycode.session import ChatSession
from julycode.skills import LoadSkillTool, SkillManager, SkillRoots
from julycode.subagents.models import SubAgentInvocation, SubAgentResult
from julycode.subagents.tools import DelegateAgentTool
...
def _skill_manager(workspace: Path, registry: Any) -> SkillManager:
    manager = SkillManager(
        SkillRoots(
            project=workspace / ".julycode" / "skills",
            user=workspace / ".julycode-user" / "skills",
