...
from julycode.context.models import ContextConfig, ContextExternalRef, ToolCompactionResult
...
class ToolResultCompactor:
    ...
    def _already_externalized(self, message: ChatMessage) -> bool:
        ...
        try:
            ...
            return False
        return isinstance(parsed, dict) and parsed.get("julycode_externalized") is True
