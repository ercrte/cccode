...
from julycode.memory.extraction import (
    MemoryCandidateValidator,
    MemoryExtractionError,
    parse_memory_candidates,
)
from julycode.memory.index import MemoryIndexBuilder
from julycode.memory.models import MemoryExtractionResult, MemoryUpdateJob, MemoryScope
from julycode.memory.notes import MemoryNoteStore
from julycode.providers.base import ChatMessage, ChatRequest, LLMProvider
...
class MemoryNoteUpdater:
    ...
    def _prompt(self, job: MemoryUpdateJob) -> str:
        ...
        return (
            "你正在为 JulyCode 提取可跨会话使用的长期记忆。禁止调用任何工具。\n"
