...
from julycode.config import RepoMapConfig
from julycode.repo_map.discovery import DISCOVERY_VERSION, build_workspace_state, scan_repository
from julycode.repo_map.graph import GRAPH_VERSION, RepoGraphBuilder
...
from julycode.repo_map.parser import PARSER_VERSION, PythonSymbolParser
from julycode.repo_map.ranking import RANKING_VERSION, rank_symbols
from julycode.repo_map.renderer import RENDERER_VERSION, RepoMapRenderer
...
class RepoMapManager:
    def __init__(
        ...
        *,
        ...
        self._executor = ThreadPoolExecutor(max_workers=1, thread_name_prefix="julycode-repo-map")
