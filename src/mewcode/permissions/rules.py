...
from mewcode.matching import match_expression, parse_match_expression
...
class PermissionRuleStore:
    def __init__(
        ...
        *,
        ...
        self.local_path = self.cwd / ".mewcode.permissions.local.yaml"
    ...
    def load(cls, cwd: Path) -> PermissionRuleStore:
        ...
        return cls(
            ...
            project_rules=_load_rule_set(root / ".mewcode.permissions.yaml", "project", parser),
            local_rules=_load_rule_set(root / ".mewcode.permissions.local.yaml", "local", parser),
        )
...
def user_permissions_path() -> Path:
    return Path.home() / ".mewcode" / "permissions.yaml"
