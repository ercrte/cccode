...
from mewcode.agent import AgentProgress
from mewcode.commands import AgentMode, CommandDefinition
...
class StatusBar(Static):
    ...
    def refresh_status(self) -> None:
        ...
        self.update(Text(f"MewCode | {mode} | {self.protocol} | {self.model} | {state}{progress}{usage}{permission}{error}"))
