...
from mewcode.permissions.models import PermissionEventPayload
from mewcode.tools.base import ToolCall, ToolResult, ToolSpec
from mewcode.tools.executor import ToolExecutor
from mewcode.tools.registry import ToolRegistry

if TYPE_CHECKING:
    from mewcode.subagents.models import SubAgentToolFilter
...
class ToolCallScheduler:
    ...
    async def run(self, calls: Sequence[ToolCall]) -> AsyncIterator[object]:
        from mewcode.agent import TurnEvent
    ...
    async def _before_tool(self, call: ToolCall):
        if self.hook_manager is None or self.hook_context is None:
            from mewcode.hooks.models import HookToolDecision
