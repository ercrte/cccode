...
from mewcode.repo_map.models import RankedSymbol, RenderedRepoMap
...
class RepoMapRenderer:
    ...
    def _preamble(self, root: Path, revision: str) -> tuple[str, ...]:
        ...
        return (
            f'<mewcode_repo_map trust="untrusted_repository_data" revision="{revision[:12]}">',
